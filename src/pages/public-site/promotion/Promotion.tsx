...
import { PromotionCard, type PromotionTeaser } from './PromotionCard';
...
export const PROMOTIONS: PromotionTeaser[] = [
  {
  ...
  return (
    <div className="min-h-screen bg-background pb-20 text-foreground">
      ...
      <main className="container-main">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">{PROMOTIONS.map((promotion) => <PromotionCard key={promotion.id} promotion={promotion} />)}</div>
